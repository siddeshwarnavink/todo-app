...
class CreateGroupTask extends Component {
          ...
          controls: {
               ...
               description: {
                    ...
                    elementConfig: {
                         label: 'Description',
                         placeholder:
                              'eg. My first task is to take care of the documents',
                    },
                    value: '',
                    validation: {
                         required: true,
     ...
     componentDidMount() {
          ...
          this.setState(prvState => {
               let updatedControls = { ...prvState.controls };

               if (this.props.isTodo) {
                    delete updatedControls.members;
               }
     ...
     submitHandler = event => {
          ...
          const task = {
               ...
               members: this.props.isTodo
                    ? []
                    : this.state.controls.members.value,
...
const mapDispatchToProps = dispatch => ({
     onCreateTask: (task, goFunc, isTodo, extFunc) =>
          dispatch(actions.createTask(task, goFunc, isTodo, extFunc)),
});
